...
This is the Docker Image for [prometheus_varnish_exporter](https://github.com/otto-de/prometheus_varnish_exporter) sidecar container to expose Prometheus metrics for Varnish.
